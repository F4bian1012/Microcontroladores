// ======================================================================
// Multiplexor.v generated from TopDesign.cysch
// 02/05/2025 at 15:31
...
module top ;
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_17 or Net_18 or Net_27)
        begin
            case (Net_27)
                1'b0 :  tmp__mux_1_reg = Net_17;
                1'b1 :  tmp__mux_1_reg = Net_18;
            endcase
        end
        assign Net_26 = tmp__mux_1_reg;
    end
    // -- Mux end --
	...
	cy_psoc3_pins_v1_10
		#(.id("deb22085-c8e6-4691-8448-cf3e0db77a60"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("dc83414c-5d9c-42cc-a48b-e824062a882b"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
